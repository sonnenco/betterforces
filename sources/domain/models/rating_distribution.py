...
class RatingDistribution(BaseModel):
    ...
    rating_points: List[RatingPoint] = Field(
        ..., description="List of solved problems with timestamps and ratings"
    )
    ...
    rating_growth_periods: List[str] = Field(
        default_factory=list, description="Periods where significant rating growth occurred"
    )
